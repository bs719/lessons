...
'difference (-) находит разницу из set1 при помощи и set2'
...
'symmetric_difference - находит разницу из двух сетов'

# set1 = {1,2,3}
# set2 = {3,4,5}
# print(set1.symmetric_difference(set2))    #{1,2,4,5}

'intersection (&) - находит схожие элементы из двух сетов set1, set2'
